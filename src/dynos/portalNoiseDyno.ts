...
/**
 * Futuristic Noise-Driven Portal Dyno.
 * Includes:
 * - 3D Simplex Noise for displacement and veins.
 * - Rhythmic pulsing for a "breathing" effect.
 * - Hover-based turbulence intensity.
 */
export const PortalNoiseDyno = new dyno.Dyno({
  inTypes: { 
    gsplat: dyno.Gsplat, 
    color: "vec3",
    uTime: "float",
